...
public class PresidentProfile {
	...
	//Get the president profile information from the database
	public static HBox president_Form_Database()
	{
        ...
        try {
            ...
            String sql = "SELECT FirstName, LastName, Gender, Dob, BloodType, Contract, Nationality, MaritualStatus FROM president";
           ...
           HBox root = president_Information_List(fNameDB, lNameDB , genderDB, dobDB, bloodTypeDB, contractDB, nationality, maritualStatus);
	...
	//Display president profile informations
	public static HBox president_Information_List(String fNameDB, String lNameDB , String genderDB, Date dobDB, String bloodTypeDB, String contractDB, String nationality, String maritualStatus)
	{
